...
export const t: Dict = {
  ...
  factWifi: { en: "Fast Wi-Fi & AC", de: "Schnelles WLAN & Klimaanlage" },
  ...
  highlight1Text: {
    en: "A quiet, residential street in Višnjik — yet only 15 minutes on foot to Baščaršija (Old Town) and 5 minutes to the University Clinical Centre (KCUS).",
    de: "Eine ruhige Wohnstraße in Višnjik — und dennoch nur 15 Gehminuten von Baščaršija (Altstadt) und 5 Minuten vom Universitätsklinikum (KCUS) entfernt."
  },
  ...
  extendedStayText: {
    en: "Whether you are a remote worker, a family exploring the Balkans, or visiting nearby institutions like the University Clinical Centre (KCUS), our fully-equipped kitchen and quiet neighbourhood offer the perfect home base for a longer stay.",
    de: "Ob Sie remote arbeiten, mit der Familie den Balkan erkunden oder das nahegelegene Universitätsklinikum (KCUS) besuchen — unsere voll ausgestattete Küche und die ruhige Umgebung bieten die perfekte Basis für einen längeren Aufenthalt."
  },
  ...
  neighbourhoodText: {
    en: "Višnjik offers the perfect balance — a peaceful, green and prestigious residential haven just a short walk from Sarajevo's vibrant historic heart. Charming low-rise buildings, tree-lined streets and a strong community feel meet daily conveniences like bakeries, supermarkets and authentic local eateries right around the corner.",
    de: "Višnjik bietet die perfekte Balance — eine ruhige, grüne und begehrte Wohngegend, nur einen kurzen Spaziergang vom pulsierenden historischen Herzen Sarajevos entfernt. Charmante niedrige Gebäude, baumbestandene Straßen und ein starkes Gemeinschaftsgefühl treffen auf Bäckereien, Supermärkte und authentische lokale Lokale direkt um die Ecke."
  },
  neighbourhoodMedical: {
    en: "For guests visiting the University Clinical Centre (KCUS), the location is unparalleled — just a 5-minute walk away, making it incredibly convenient for medical professionals or patients.",
    de: "Für Gäste, die das Universitätsklinikum (KCUS) besuchen, ist die Lage unschlagbar — nur 5 Gehminuten entfernt, was es für medizinisches Personal oder Patienten äußerst praktisch macht."
  },

  reviewsTitle: { en: "What Guests Are Saying", de: "Was Gäste sagen" },
  reviewsSubtitle: {
    en: "Real, verified reviews from guests on Booking.com.",
    de: "Echte, verifizierte Bewertungen von Gästen auf Booking.com."
  },
