  ...
  return (
    <div>
      <section className="relative h-[92vh] min-h-[560px] w-full overflow-hidden flex items-center justify-center text-center">
        <div className="absolute inset-0 bg-gray-300">
          <Image
            ...
            alt="Cherry Magic Apartment Sarajevo exterior"
            fill
            priority
          ...
          <div className="bg-cream shadow-lg rounded-2xl grid grid-cols-2 md:grid-cols-6 gap-6 px-6 py-8 border border-cherry/10">
            {facts.map((f, i) => (
              <div key={i} className="flex flex-col items-center text-center gap-2 text-charcoal">
                ...
                <p className="font-body text-xs md:text-sm">{f.label}</p>
              </div>
            ))}
          </div>
        </FadeUp>
      ...
      <section className="max-w-6xl mx-auto px-5 py-20">
        <FadeUp>
          <h2 className="font-heading text-3xl md:text-4xl text-center text-charcoal mb-14">
            {tr("highlightsTitle")}
          </h2>
        </FadeUp>
          ...
          {[
            ...
            <FadeUp key={i} delay={i * 100}>
              <div className="bg-white/60 border border-cherry/10 rounded-2xl p-7 h-full">
                <h3 className="font-heading text-xl text-cherry mb-3">{h.t}</h3>
      ...
      <section className="bg-cherry/5 py-20">
      ...
      <section className="max-w-6xl mx-auto px-5 py-20">
        <FadeUp>
          <h2 className="font-heading text-3xl md:text-4xl text-center text-charcoal mb-3">
            {tr("galleryTitle")}
          </h2>
            ...
            <FadeUp key={room.slug} delay={i * 80}>
              ...
              >
                ...
                <div className="absolute inset-0 bg-charcoal/30 flex items-end p-3">
                  <span className="text-cream font-body text-sm">
